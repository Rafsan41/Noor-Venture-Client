          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-amber-400"
              />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border px-3 py-2.5 text-sm pr-10 outline-none focus:ring-2 focus:ring-amber-400"
                />
                <button
                  type="button"
