    ...
    <AdminShell>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard title="Total Users"        value={stats?.users.total ?? 0}          icon={Users}      color="coral" />
          <StatCard title="Total Proposals"    value={stats?.proposals.total ?? 0}      icon={FileText}   color="blue" />
          <StatCard title="Total Investments"  value={stats?.investments.total ?? 0}    icon={TrendingUp} color="emerald" />
          <StatCard
            title="Total Capital"
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="noor-card p-4 text-center">
            <div className="text-2xl font-bold text-emerald-600">{stats?.users.investors ?? 0}</div>
            <div className="text-xs text-muted-foreground mt-1">Investors</div>
          </div>
          <div className="noor-card p-4 text-center">
            <div className="text-2xl font-bold text-coral-600">{stats?.users.owners ?? 0}</div>
            <div className="text-xs text-muted-foreground mt-1">Business Owners</div>
          </div>
          <div className="noor-card p-4 text-center">
            <div className="text-2xl font-bold text-purple-600">{stats?.proposals.pending ?? 0}</div>
